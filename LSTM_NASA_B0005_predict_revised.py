# -*- coding: utf-8 -*-
"""
Created on Thu Sep 19 11:29:24 2019
...
#Apply LSTM
regress=Sequential()
regress.add(LSTM(units=150, return_sequences=True, input_shape=(X_train.shape[1],1)))
...
regress.save('B0005_cycle80_training model_1')
